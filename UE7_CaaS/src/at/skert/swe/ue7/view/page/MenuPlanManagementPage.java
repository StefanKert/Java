package at.skert.swe.ue7.view.page;
...
import at.skert.swe.ue7.view.utils.GenericListCellWithButtons;
...
public class MenuPlanManagementPage extends AnchorPane {
  ...
  private Pane createCategoryView() {
    ...
    pane.getChildren().addAll(
        createTitleHeadBox("Kategorie", createAddMenuCategoryButton()),
        createMenuCategoryListView());
    return pane;
  }
  ...
  private ListView<MenuCategory> createMenuCategoryListView() {
    ...
    categoryListView
        .setCellFactory(p -> {
          GenericListCellWithButtons<MenuCategory> cell = new GenericListCellWithButtons<MenuCategory>(
              false, true);
          cell.setDeleteMethod(menuCategory -> viewModel
  ...
  private Pane createMenuView() {
    ...
    pane.getChildren()
        .addAll(createTitleHeadBox("Menü", createAddMenuButton()),
            createMenuListView());
    return pane;
  }
  ...
  private ListView<Menu> createMenuListView() {
    ...
    menuListView
        .setCellFactory(p -> {
          GenericListCellWithButtons<Menu> cell = new GenericListCellWithButtons<Menu>(
              false, true);
